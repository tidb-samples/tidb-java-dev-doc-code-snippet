# TiDB Developer Documentation Java Code Snippets

English | [中文](/README-zh.md)

This is the repository for storing Java code snippets in the PingCAP [developer documentation](https://docs.pingcap.com/tidb/stable/dev-guide-overview).
...
1. Navigate to the example directory you want to run. Let's assume you want to enter the `batch-delete` example:
